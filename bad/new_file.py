...
new_file = Blueprint('new_file', __name__, template_folder='templates')


@new_file.route('/login', methods=['GET', 'POST'])
def do_login():
...
@new_file.route('/create', methods=['GET', 'POST'])
def do_create():
...
@new_file.route('/chpasswd', methods=['GET', 'POST'])
def do_chpasswd():
